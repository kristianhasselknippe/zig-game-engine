...
pub const mat4_identity = Mat4{ .data = [_][4]f32{
    [_]f32{ 1.0, 0.0, 0.0, 0.0 },
    [_]f32{ 0.0, 1.0, 0.0, 0.0 },
    [_]f32{ 0.0, 0.0, 1.0, 0.0 },
...
fn testScale() void {
    ...
    const expected = Mat4{ .data = [_][4]f32{
...
fn testMult() void {
    ...
    const answer = Mat4{ .data = [_][4]f32{
